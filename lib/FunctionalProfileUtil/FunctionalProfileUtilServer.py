...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'FunctionalProfileUtil'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from FunctionalProfileUtil.FunctionalProfileUtilImpl import FunctionalProfileUtil  # noqa @IgnorePep8
impl_FunctionalProfileUtil = FunctionalProfileUtil(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'FunctionalProfileUtil'
